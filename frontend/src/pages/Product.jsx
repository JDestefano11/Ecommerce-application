        ...
        <div className="flex gap-12 flex-col sm:flex-row">
          ...
          <div className="flex-1 flex flex-col-reverse gap-3 sm:flex-row">
            ...
            <div className="w-full sm:w-[80%]">
              <img className="w-full h-auto border-2 border-[#708090]" src={image} alt="" />
            </div>
          </div>
          {/* Product details */}
          <div className="flex-1">
            <h1 className="font-bold text-3xl mt-2 text-[#2F4F4F]">{productData.name}</h1>
            ...
            <div className="flex flex-col gap-4 my-8">
              ...
              <div className="flex gap-2">
                {productData.sizes.map((item, index) => (
                  <button
                    className={`border py-2 px-4 bg-white text-[#708090] ${item === size ? 'border-[#FFC0CB] bg-[#FFC0CB] text-white' : "border-[#708090]"} hover:bg-[#FFC0CB] hover:text-white transition duration-300`}
                    key={index}
