              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                ...
                <div className="flex gap-6">
                  ...
                  <div className="flex flex-col justify-center">
                    <h3 className="text-xl font-semibold text-[#2F4F4F]">{item.name}</h3>
                    <p className="text-[#708090] mt-2">Price: {currency}{item.price.toFixed(2)}</p>
                    <p className="text-[#708090] mt-1">Quantity: 1</p>
                    <p className="text-[#708090] font-medium mt-1">Status: {status}</p>
                  </div>
                </div>
                {/* Order total, date, and tracking information */}
                <div className="flex flex-col items-end">
                  <p className="text-lg font-semibold text-[#2F4F4F]">Total: {currency}{item.price.toFixed(2)}</p>
                  <p className="text-[#708090] mt-2">Order Date: {orderDate.toLocaleDateString()}</p>
                  <button
                  ...
                  {trackingNumbers[index] && (
                    <p className="text-[#708090] mt-2">Tracking #: {trackingNumbers[index]}</p>
                  )}
                </div>
              </div>
            </div>
